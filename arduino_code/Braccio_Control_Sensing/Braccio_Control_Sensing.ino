...
void setup(){
  ...
  Serial.println(OCR1CH);
  Serial.println(OCR1CL);
  Serial.println();
...
void init_Motors(){
  ...
  delay(2000);       // Wait for the Analog Value to stabilize
  ...
  Serial.print(val_m_1); Serial.print(" ");
  Serial.print(val_m_2); Serial.print(" ");
  Serial.print(val_m_3); Serial.print(" ");
  Serial.print(val_m_4); Serial.print(" ");
  Serial.print(val_m_5); Serial.print(" ");
  Serial.print(val_m_6); Serial.print(" ");
  Serial.println();
}
/***************************************************************************/
/***************************************************************************/
...
void loop() {
  ...
  if( TIMSK1 ==0){
    if((goal_m_1 != val_m_1) || (goal_m_2 != val_m_2) || (goal_m_3 != val_m_3) || (goal_m_4 != val_m_4) || (goal_m_5 != val_m_5) || (goal_m_6 != val_m_6)){
      Serial.println("Position not reached, attaching int");
      TIMSK1 |= (1 << OCIE1C); // Set interrupt for channel C
    }
  }
  // Send command and sense the motor position
  sendCmd();
  sensingPosition();
